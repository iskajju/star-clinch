    ...
    return (
        <div className='flex  pt-[15px] pb-[15px] ' >
            ...
            <div className='w-[389px] ' >
                <img className='h-full w-full rounded-t-[10px] ' src={photo} alt="" />
            </div>
            {/* profile details */}
            <div className='pl-[55px] pt-[62px] ' >
                <div>
                ...
                <div>
                <button className='text-[15px] font-bold w-[300px] rounded-[20px] h-[42x] mt-[25px] mb-[20px] header-button p-[8px]'>See Price And Book </button>
