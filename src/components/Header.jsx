        ...
        <header className='fixed top-0 left-0 right-0 ' >
            <div className="container md:max-w-[720px] lg:max-w-[1140px]">
                <div className="inner_container">
                    ...
                    <div className="brand-logo  max-w-[16.666667%] px-[15px] ">
                        <img className='h-[40px] w-full' src="https://starclinch.com/static/images/home/StarClinch-Logo-new.svg" alt="no-image" />
                    </div>
                    ...
                    <div className=" flex-[0 0 83.333333%] lg:hidden  ">
                        <ul className='flex items-center  text-[#070707] text-sm  '>
                        <li>
